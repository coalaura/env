...
- Unless the project follows another convention, organize Go files (top to bottom) as: constants -> types -> package variables -> methods -> package-level functions -> helpers.
